...
{	public Utils() {}
	...
	// RUBY material - ambient, diffuse, specular, and shininess
		// http://devernay.free.fr/cours/opengl/materials.html
	public static float[] rubyAmbient()  { return (new float [] {0.1745f  ,  0.01175f , 0.01175f , 1} ); }
	public static float[] rubyDiffuse()  { return (new float [] {0.61424f ,  0.04136f , 0.04136f , 1} ); }
	public static float[] rubySpecular() { return (new float [] {0.727811f,  0.626959f, 0.626959f, 1} ); }
	public static float rubyShininess()  { return 0.6f; }
	
	// PEARL material - ambient, diffuse, specular, and shininess
		// http://devernay.free.fr/cours/opengl/materials.html
	public static float[] pearlAmbient()  { return (new float [] {0.25f    ,  0.20725f , 0.20725f , 1} ); }
	public static float[] pearlDiffuse()  { return (new float [] {1.0f     ,  0.829f   , 0.829f   , 1} ); }
	public static float[] pearlSpecular() { return (new float [] {0.296648f,  0.296648f, 0.296648f, 1} ); }
	public static float pearlShininess()  { return 0.088f; }
}